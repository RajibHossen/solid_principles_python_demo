"""
Good example of Dependency Inversion of SOLID principles
We will make interface for switch and switchable client
then implement ISwitch in ElectricPowerSwitch class with object of class that
implement ISwitchable interface.
From ElectricPowerSwitch we can call Switchable client and ElectricPowerSwitch
don't need to modify. We can always add switchable client without depending on
